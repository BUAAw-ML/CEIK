...
vinvl_dataset_tsv = '../materials/scene_graph_benchmark/datasets/okvqa/test.hw.tsv'
prefix = 'test'
...
sg_tsv = '../data/okvqa/pre-extracted_features/vinvl_output/vinvl_okvqa_testset/inference/vinvl_vg_x152c4/predictions.tsv'
...
OUTPUT_DIR = '../materials/scene_graph_benchmark/datasets/okvqa_for_oscar'
